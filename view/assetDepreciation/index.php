...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <h1 class="text-success text-center">Asset Depreciation</h1>
        <button class="btn btn-success rounded-10 mb-2" onclick="openAddModal()"><i class="bi bi-plus-square-fill"></i>Add Depreciation</button>

        <!-- DATA TABLE -->
            <div id="depreciationFetch"></div>
        <!-- END DATA TABLE -->

        <!-- MODALS -->
        <?php include('../../modals/assetDepreciationModal.php'); ?>
        <!-- END MODALS -->
...
<script>
  ...
  $(document).on("click", "#addDepreciation", function() { 
  $.ajax({
      url: "checkExist.php",
      type: "POST",
      cache: false,
