<?php
$connect = new PDO("mysql:host=localhost;dbname=supply", "root", "");
 ...
 <body>
  ...
  <div class="container">
   <div class="row">
    ...
    ?>
     <div class="checkbox">
      <label><input type="checkbox" class="checkbox_table" name="table[]" value="<?php echo $table["Tables_in_supply"]; ?>" /> <?php echo $table["Tables_in_supply"]; ?></label>
     </div>
    <?php
    }
    ?>
